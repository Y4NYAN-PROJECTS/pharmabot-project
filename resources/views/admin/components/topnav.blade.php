                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                        ...
                        <li>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit"
                                    class="dropdown-item text-danger fw-bold d-flex align-items-center gap-2 border-0 bg-transparent w-100 py-2">
                                    <i class="bi bi-box-arrow-left me-3"><small class="ms-2">Logout</small></i>
                                </button>
                            </form>
                        </li>
                    </ul>
